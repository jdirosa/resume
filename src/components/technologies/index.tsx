...
export const SecondFrame: React.FunctionComponent = () => {
  return (
    <div style={{ backgroundColor: 'rgba(0,0,0,.001)' }}>
      <VerticalSpacer custom={240} />
          ...
          <Row>
            ...
            <Col>
              ...
              <p>
                ...
                zone. I absolutely love designing each layer of the stack within
                a SPA; from the first database table to the final cloud deploy.
              </p>
              <VerticalSpacer />
              <h3>
                <Accents.Gold>
                  <FaBook style={{ fontSize: 42, paddingRight: 12 }} />
                </Accents.Gold>
                Code Philosophy
              </h3>
              <p>
